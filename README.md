...
- Evaluating the relevance and quality of retrieved documents **before passing them to the model**  
...
**Key difference:**  
- **Standard RAG:** Passes retrieved documents directly to the model.  
- **Corrective RAG (cRAG):** **Evaluates retrieved documents first** using a Retrieval Evaluator, then corrects, refines, or supplements the context before generation. This helps reduce hallucinations and improves answer accuracy.

---

## 🛠️ Implementation Highlights

- Implemented a **Corrective RAG pipeline** demonstrating evaluation and refinement of retrieved context  
- After retrieval, documents are **assessed for quality** (Correct / Incorrect / Ambiguous) before being used by the model  
